...
/**
 * Provides general purpose combo box support for Java enumerated types. The {@link Enum#toString()}
 * method is invoked to retrieve the text for each choice. To support translatable text, override the
 * {@code toString} method for the enumerated type and/or choices.
 * 
 * @param <T>
 */
public class EnumComboBox<T extends Enum<T>> extends ComboBox<T> {
    ...
    /**
     * Constructs an enumerated combo box with the specified values. To include all of the values for an
     * enum, use:
     * <p/>
