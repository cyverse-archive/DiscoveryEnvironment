 ...
 */
package org.iplantc.de.client.gxt3.desktop.theme;

import org.iplantc.de.client.gxt3.desktop.widget.ShortcutCell.ShortcutCellAppearance;
...
public class ShortcutCellDefaultAppearance<C> extends ButtonCellDefaultAppearance<C> implements
    ...
    public ShortcutCellDefaultAppearance() {
        super(GWT.<ButtonCellResources> create(ShortcutCellResources.class), GWT
