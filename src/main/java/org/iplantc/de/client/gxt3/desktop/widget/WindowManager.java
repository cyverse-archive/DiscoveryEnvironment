...
public class WindowManager {
    ...
    /**
     * Adds a handler registration for the specified window. The handler registrations for a window may
     * be removed using {@link #removeRegisteredHandlers(Window)}.
     * 
     * @param window the window
     * @param handlerRegistration a handler association for the window
     * 
     * @throws IllegalArgumentException if the window is not in the list of managed windows
     */
    public void addHandlerRegistration(Window window, HandlerRegistration handlerRegistration) {
        getWindowDescriptor(window).getHandlerRegistrations()
    ...
    /**
     * Returns the window that contains the specified widget as its top level widget, or null if no
     * window contains the widget.
     * 
     * @param widget the widget to search for
     * @return the window containing the widget as its top level wiget, or null if no windows contains
     *         the widget
     */
